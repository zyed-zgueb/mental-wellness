...
def show_login_form():
    ...
    with right_col:
        ...
        st.markdown("""
        <div style='text-align: center; color: white; padding-top: 10vh;'>
...
def show_forgot_password_form():
    ...
    with left_col:
        ...
        <div style="background: white; border-radius: 24px; padding: 3rem 2.5rem;
                    box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); max-width: 440px; margin: 0 auto;">
            <h1 style='font-family: "Inter", sans-serif; font-size: 1.75rem; font-weight: 600;
                       color: #1A1A1A; margin-bottom: 1rem; margin-top: 0; line-height: 1.3;'>
                Reset Your Password
            </h1>
        ...
        # Back to login link
        if st.button("← Back to Login", key="goto_login_from_forgot", type="secondary"):
            st.session_state.auth_page = "login"
            st.rerun()
